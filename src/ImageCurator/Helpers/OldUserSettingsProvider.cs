namespace ImageCurator.Helpers
{
    ...
    /// 
    /// Currently the wrapper uses .NET's Application Settings provider, with a single setting, which is our settings class serialized with JSON.
    /// </summary>
    public class OldUserSettingsProvider
    {
        ...
        public OldUserSettingsProvider()
        {
            //this.Initialize();
        ...
        public string RootPath
        {
            get
            {
                var shit = this.settingBase.PropertyValues[Constants.Configuration.ROOT_IMAGE_PATH];
            ...
            set
            {
                ...
                this.SetDynamicSetting(Constants.Configuration.ROOT_IMAGE_PATH, value);
            }
        }
